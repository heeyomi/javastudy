...
//		File file = new File(DOCUMENTROOT + url);
		...
		String contentType = URLConnection.guessContentTypeFromName(DOCUMENTROOT+url);
...
//		}
		...
		String contentType = URLConnection.guessContentTypeFromName(DOCUMENTROOT+"/error/400.html");
...
//		String contentType = Files.probeContentType(Paths.get(DOCUMENTROOT + "/error/404.html"));
		String contentType = URLConnection.guessContentTypeFromName(DOCUMENTROOT+"/error/404.html");
